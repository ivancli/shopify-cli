    ...
    class Push < ShopifyCLI::Command::SubCommand
      ...
      def call(_args, _name)
        ...
        # end
         ...
         # determine if we need to invoke the form 2.0
         fresh_env = !Layers::Application::ConnectApp.env_valid?(ctx:@ctx)
         Layers::Application::ConnectApp.call(ctx:@ctx) if fresh_env
